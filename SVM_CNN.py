...
main = tkinter.Tk()
main.title("Detection of lung cancer from CT image using SVM classification compare the survival rate of patient using 3D(CNN)")
...
font = ('times', 14, 'bold')
title = Label(main, text='Detection of lung cancer from CT image using SVM classification compare the survival rate of patient using 3D(CNN)')
